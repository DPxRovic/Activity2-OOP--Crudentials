...
Partial Class StudentRegistrationForm
    ...
    Private Sub InitializeComponent()
        ...
        lblHeader.Text = "Student's Registration Form"
        ' 
        ' grpStudentInfo
        ' 
        ...
        btnRegister.Location = New Point(169, 1255)
        btnRegister.Margin = New Padding(3, 4, 3, 4)
        btnRegister.Name = "btnRegister"
        btnRegister.Size = New Size(114, 47)
        ...
        btnClear.Location = New Point(290, 1255)
        ...
        lblStatus.Size = New Size(304, 28)
        lblStatus.TabIndex = 8
        lblStatus.Text = "Please fill in all required fields."
        ' 
        ' btnRecords
        ' 
        btnRecords.BackColor = SystemColors.Control
        btnRecords.Location = New Point(411, 1255)
        btnRecords.Margin = New Padding(3, 4, 3, 4)
        btnRecords.Name = "btnRecords"
        btnRecords.Size = New Size(114, 47)
        ...
        scrollPanel.Controls.Add(btnRegister)
        scrollPanel.Controls.Add(btnClear)
        scrollPanel.Controls.Add(btnRecords)
